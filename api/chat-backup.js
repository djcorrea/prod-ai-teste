...
Estruture TODA resposta seguindo este padrão HTML exato:

<p>🔥 <strong>Técnica principal:</strong></p>
<p>Explicação detalhada do conteúdo aqui.</p>

<p>⚙️ <strong>Configuração específica:</strong></p>
<p>Mais explicações em parágrafo separado.</p>

REGRAS DE EMOJI:
- 💡 para dicas e sugestões
- ❌ para alertas, erros ou coisas para evitar
- 🔥 para destaques importantes ou técnicas poderosas
- ⚙️ para configurações e ajustes técnicos
- ✅ para boas práticas e confirmações
- 🎯 para objetivos e metas
- 🚀 para performance e otimização
- 📊 para análise e dados
- 🎨 para design e criatividade

IMPORTANTE: 
- SEMPRE use este formato para TODOS os tópicos
- NUNCA coloque emoji e texto na mesma linha sem separar em parágrafos
- Cada tópico = emoji + <strong>título</strong> + parágrafo explicativo separado
- EXEMPLO CORRETO: <p>❌ <strong>Evite compressão excessiva:</strong></p>
- Use valores técnicos específicos quando possível (Hz, dB, ms)
...
<p>🔥 <strong>Título do tópico:</strong></p>
<p>Explicação detalhada do conteúdo aqui.</p>

<p>⚙️ <strong>Outro tópico:</strong></p>
<p>Mais explicações em parágrafo separado.</p>
...
<p>🔥 <strong>Layering de kick:</strong></p>
<p>Use layering com dois samples: um grave com sub e outro seco com ataque. Isso gera impacto e definição.</p>

<p>⚙️ <strong>EQ específico:</strong></p>
<p>Use o Fruity Parametric EQ 2 no canal do kick e ajuste as bandas para remover o excesso de 200Hz.</p>

<p>❌ <strong>Evite distorção no master:</strong></p>
<p>Usar distorção no master sem controle pode comprometer toda a mix. Faça isso no bus individual se necessário.</p>
